...
object FirebaseFunctionHelper {
            ...
            subjectitem.Lessons.forEach { lessonitem ->
                list.add(
                    hashMapOf(
                        ...
                        "begin" to FormatDate.getTimeStringFromCalendar(lessonitem.startTime),
                        "end" to FormatDate.getTimeStringFromCalendar(lessonitem.endTime)
                    )
                )
            }
        }
    ...
    fun saveGrade(grade: Grade): Task<String> {
        ...
        val data: HashMap<String, String> = hashMapOf(
            ...
            "date" to FormatDate.getStringFromCalendar(grade.date),
